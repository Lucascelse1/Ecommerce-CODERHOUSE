...
const ItemDetail = ({ name, img, price, stock, category, description }) => {
    ...
    return (
        <section className="w-full flex justify-center">
            <article className="bg-[#414e58] w-3/12 text-white flex flex-col items-center rounded-lg p-4 gap-y-4 shadow-[0_0_20px_0_black] tracking-widest">
            ...
            <article className="w-4/12 p-8 text-white tracking-widest text-xl">
                <p> {description} </p>
            </article>
        </section>
